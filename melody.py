...
def about_us():
    tkinter.messagebox.showinfo('About Melody', ' MADE BY HARSHIT PANDEY AND SURBHI SOLANI ')
...
facebtn=Button(leftframe3,text='ADD NEW FACE',font=('times',15,'bold'),bg='black',fg='white',relief=GROOVE,command=face)
facebtn.grid(row=2, column=1)
